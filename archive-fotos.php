  ...
  <div class="row gx-5">
    <div class="col-lg-8">
      <section class="row mb-4">
        <h1 class="h2 text-mcz-foto fw-bold mb-4">Fotos</h2>
        <form class="d-flex mb-3" role="search">
            <div class="input-group ">
              <input name="s" class="form-control" type="search" placeholder="Encontra seu evento" aria-label="Search">
              <button class="btn btn-mcz-foto text-white" type="submit">Buscar</button>
            </div>
        </form>
        <?php
